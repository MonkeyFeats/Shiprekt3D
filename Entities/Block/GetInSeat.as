...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if((this.getPosition()- caller.get_Vec2f("aim_pos")).Length() > Block::BUTTON_RADIUS_FLOOR
    ...
    if (cmd == this.getCommandID("get in seat"))
    {
		if ( getNet().isServer() )
		{
			...
			if ( true )
				...
				caller.set_f32("dir_x", angle);
				caller.set_f32("eye height", -2.5f);
		}
	}
}
...
void onDetach( CBlob@ this, CBlob@ detached, AttachmentPoint @attachedPoint )
{
	...
	detached.set_f32("eye height", -1.05f);
}