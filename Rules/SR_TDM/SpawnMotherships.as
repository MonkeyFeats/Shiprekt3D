...
void SpawnMothership( Vec2f pos, const int team )
{
	...
	makeBlock( pos + Vec2f(-Block::size, -Block::size), 0.0f, Block::PLATFORM, team );
	makeBlock( pos + Vec2f(0, -Block::size), 0.0f, Block::PLATFORM, team );
	makeBlock( pos + Vec2f(Block::size, -Block::size), 0.0f, Block::PLATFORM, team );

	makeBlock( pos + Vec2f(-Block::size, 0), 0.0f, Block::PLATFORM, team );
	makeBlock( pos, 0.0f, Block::PLATFORM, team ); makeBlock( pos, 0.0f, Block::SHIPCORE, team ).AddScript("Mothership.as");
	makeBlock( pos + Vec2f(Block::size, 0), 0.0f, Block::PLATFORM, team );
	...
	makeBlock( pos + Vec2f(-Block::size*2, -Block::size*1), 0.0f, Block::RAMENGINE, team );
	...
	makeBlock( pos + Vec2f( Block::size*2, Block::size*2), 0.0f, Block::RAMENGINE, team );
	makeBlock( pos + Vec2f( Block::size*1, Block::size*2), 0.0f, Block::RAMENGINE, team );

	makeBlock( pos + Vec2f( 0, Block::size*2), 270.0f, Block::SEAT, team );
